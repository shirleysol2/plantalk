  ...
  return (
    <div className={`plink-logo ${className}`.trim()} aria-label="Plink" role="img">
      <svg className="plink-logo-mark" viewBox="0 0 92 78" aria-hidden="true">
        ...
        <circle className="plink-logo-eye" cx="29.5" cy="35" r="2.4" />
        <circle className="plink-logo-eye" cx="45.5" cy="35" r="2.4" />
        <path className="plink-logo-smile" d="M30.8 45.1c3.5 5.1 10.2 5.1 13.8 0" />
      </svg>
